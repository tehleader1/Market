(function(){
  ...
  function css(){
    ...
    s.textContent=`
      ...
      .lm-alt-reader-grid{display:grid;grid-template-columns:repeat(4,minmax(190px,1fr));gap:.7rem;margin:.9rem 0}.lm-alt-reader{border:1px solid rgba(255,255,255,.12);border-radius:16px;background:#07101f;padding:.75rem;overflow:hidden}.lm-alt-reader-top{display:flex;justify-content:space-between;gap:.5rem;align-items:center}.lm-alt-reader-top strong{font-size:1.15rem}.lm-alt-reader-score{font-weight:1000;color:#ffc542}.lm-alt-mini{width:100%;height:112px;border-radius:12px;background:#030814;border:1px solid rgba(255,255,255,.08);margin:.55rem 0;display:block}.lm-alt-bb{border:1px solid rgba(255,255,255,.1);border-radius:13px;background:rgba(0,0,0,.22);padding:.55rem;margin-top:.45rem}.lm-alt-radar{height:56px;border-radius:999px;border:1px solid rgba(255,255,255,.12);background:linear-gradient(90deg,rgba(255,104,104,.2),rgba(255,255,255,.04),rgba(97,244,166,.2));position:relative;overflow:hidden}.lm-alt-red,.lm-alt-green{position:absolute;top:0;bottom:0}.lm-alt-red{left:0;background:linear-gradient(90deg,rgba(255,104,104,.82),rgba(255,104,104,.08))}.lm-alt-green{right:0;background:linear-gradient(270deg,rgba(97,244,166,.84),rgba(97,244,166,.08))}.lm-alt-line{position:absolute;top:0;bottom:0;width:2px;background:#fff;box-shadow:0 0 12px #fff}.lm-alt-center{position:absolute;inset:0;display:grid;place-items:center;text-align:center;font-weight:1000;text-shadow:0 1px 9px rgba(0,0,0,.9)}
  ...
  function gauge(d){
    ...
    return `<div class="lm-alt-bb"><div class="lm-alt-radar"><div class="lm-alt-red" style="width:${d.bear}%"></div><div class="lm-alt-green" style="width:${d.bull}%"></div><div class="lm-alt-line" style="left:${d.bear}%"></div><div class="lm-alt-center">${winner} +${Math.abs(d.bull-d.bear)}%</div></div><div class="lm-alt-counts"><div><span class="lm-alt-bear">Sell</span><strong>${d.supply}</strong></div><div><span class="lm-alt-bull">Buy</span><strong>${d.demand}</strong></div></div></div>`;
  }
